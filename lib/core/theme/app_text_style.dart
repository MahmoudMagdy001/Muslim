...
class AppTextStyles {
  ...
  TextStyle get bodyLarge => GoogleFonts.cairo(fontSize: (baseFontSize - 2).sp);

  TextStyle get bodyMedium =>
      GoogleFonts.cairo(fontSize: (baseFontSize - 4).sp);

  TextStyle get bodySmall => GoogleFonts.cairo(fontSize: (baseFontSize - 8).sp);
