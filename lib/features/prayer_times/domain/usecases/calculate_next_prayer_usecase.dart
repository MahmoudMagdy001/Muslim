...
class CalculateNextPrayerUseCase
  ...
  Future<Either<Failure, PrayerCalculationResult>> call(
    ...
    try {
      ...
      final nextPrayer = _getNextPrayerType(params, now);
      final nextPrayerDateTime = _getNextPrayerDateTime(
        params,
        nextPrayer,
        now,
      );
      final previousPrayer = _getPreviousPrayerType(params, now);
  ...
  /// Calculates synchronously for UI updates without returning a Future/Either.
